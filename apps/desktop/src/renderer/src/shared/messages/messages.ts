...
export const messages = {
  ...
  codeDiffView: {
    diffTab: 'Diff',
    fileTab: 'File',
    layoutGroupAria: 'Diff layout',
    unifiedLabel: 'Unified',
    splitLabel: 'Split',
    unifiedAria: 'Unified layout',
    splitAria: 'Split layout',
    closeAria: 'Close',
    failedToLoad: 'Failed to load diff.',
    repoNotFound: (path: string) => `Repository not found: ${path}`,
    fileTooLarge: (path: string) => `${path} is too large to display.`,
    retry: 'Retry',
    binaryPlaceholder: 'Binary file — no preview available.',
  },
  branchSelector: {
