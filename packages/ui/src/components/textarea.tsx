...
/**
 * Multi-line text field — the base-mira shadcn `textarea`, adapted to the tokens (matches `Input`'s
 * chrome). Auto-grows with its content (`field-sizing-content`); the commit-message field uses it.
 */
